...
<script
	src="<c:url value="/resource/js/angular-1.4.8.min.js"/>"></script>
<script src="<c:url value="/resource/js/productController.js"/>"></script>
</head>
<body ng-app="myapp">
	<div class="container maincontent-container" id="productTable"
		style="width: 1145px; margin-bottom: 180px;">
		<h2>Product Viewed History</h2>
		<p>The List of Products you viewed in current session</p>
				...
				<c:forEach items="${products}" var="prod">
					<tr>
						<td style="width: 171px"><img
							src="<c:url value="/productimages/${prod.productId}.jpg"/>"
